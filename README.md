...
```text
LAB-00 AÉGIDA → LAB-01 SQL Server DBA → LAB-02 Always On → LAB-03 Hardening → LAB-04 Monitoring → AD/SOC/Cloud
```
...
| [Troubleshooting](02_Laboratorios/LAB-02-SQLSERVER-ALWAYS-ON-HADR/troubleshooting.md) | Incidencias reales y resolución. |
...
El roadmap prioriza laboratorios que continúan de forma natural lo ya construido en AÉGIDA, LAB-01 y LAB-02.
...
La evolución prevista se centra en reforzar seguridad, auditoría, hardening y operación continua sobre la plataforma ya construida, manteniendo continuidad con LAB-01 y LAB-02.
